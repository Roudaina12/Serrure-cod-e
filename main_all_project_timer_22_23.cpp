...
{ 
HAL_ResumeTick();
#if defined (project1)||defined (project3)||defined (project4)||defined (project6)
Key = keypad.getKey();
 if (Key != NO_KEY){
    Serial.println(Key); 
  }
#elif defined (project2)||defined (project5)
...
Init_Start_Timer(TIM6,20,HERTZ_FORMAT);// 20 Hz
